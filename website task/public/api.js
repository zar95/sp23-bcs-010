...
function loadStoriesJQ() {
  $.ajax({
    url: "https://usmanlive.com/wp-json/api/stories",
    method: "GET",
    dataType: "json",
    success: function (data) {
      console.log("Data fetched successfully using jQuery AJAX:");
      showStories(data);
    },
    error: function (xhr, status, error) {
      console.error("Error fetching stories using jQuery AJAX:", error);
    }
  });
}

$(document).ready(function() {
  loadStoriesJQ(); // use jQuery AJAX to load stories on page load
});
